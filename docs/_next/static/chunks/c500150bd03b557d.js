(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    let v = 'undefined' != typeof performance,
      m =
        v &&
  ...
  (e, t, r) => {
    ...
    function c(e) {
      ...
      let m = e.browser.transmit;
      if (m && 'function' != typeof m.send)
      ...
      (k.log || (k.log = g),
        (l = {}),
        O.forEach((e) => {
          l[e] = w[e] ? w[e] : i[e] || i[a[e] || 'log'] || g;
        }),
        (k[s] = l),
        u({}, k),
        Object.defineProperty(k, 'levelVal', {
          get: function () {
      ...
      function P(t, r, n) {
        ...
        let i = n.serializers;
        if (j && i) {
          var o = Object.assign({}, _, i),
            s = !0 === e.browser.serialize ? Object.keys(o) : j;
        ...
        function l(e) {
          ((this._childLevel = (0 | e._childLevel) + 1),
            ...
            m && (this._logEvent = p([].concat(e._logEvent.bindings, r))));
        }
        l.prototype = this;
        let a = new l(this);
        return (
