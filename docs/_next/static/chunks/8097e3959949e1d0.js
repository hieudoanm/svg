(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, n) => {
    ...
    for (var s in r) Object.defineProperty(n, s, { enumerable: !0, get: r[s] });
  ...
  (e) => {
    ...
    let s = ({
      ...
      settings: n,
      setSettings: r,
      activeIcon: s = (0, t.jsx)(t.Fragment, {}),
      inactiveIcon: o = (0, t.jsx)(t.Fragment, {}),
    }) =>
      (0, t.jsx)('button', {
        onClick: () => r((t) => ({ ...t, [e]: !t[e] })),
        children: (0, t.jsx)('div', {
          className: `flex aspect-square w-16 items-center justify-center rounded-full ${n[e] ? 'bg-red-700' : 'bg-neutral-900'} text-neutral-100`,
          children: n[e] ? s : o,
        }),
      });
    e.s([
