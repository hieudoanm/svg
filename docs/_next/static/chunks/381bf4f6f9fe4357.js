                        ...
                        u =
                          r % 90 == 0
                            ? (0, t.jsx)('div', {
                                ...
                                className: `aspect-square w-4 rounded-full ${o ? 'bg-red-500' : 'bg-white'}`,
                              })
                            : (0, t.jsx)('div', {
                                title: ((e + 9) % 12).toString(),
                                className: `aspect-square w-2 rounded-full ${o ? 'bg-red-500' : 'bg-neutral-500'}`,
                              });
                      return (0, t.jsx)(
                        'div',
                        {
                  ...
                  children: [
                    (0, t.jsxs)('p', {
                      ...
                      children: [
                        (0, t.jsx)('span', {
                          className: 'uppercase',
                          children: o.months[u.month],
                        }),
                        ' ',
                        u.date,
                        (0, t.jsx)('sup', {
                          children: (0, o.getOrdinalSuffix)(u.date),
                        }),
                        ', ',
                        u.year,
                      ],
                    ...
                    (0, t.jsxs)('p', {
                      ...
                      children: [
                        (0, n.addZero)(u.hours),
                        ':',
                        (0, n.addZero)(u.minutes),
                        ':',
                        (0, n.addZero)(u.seconds),
                      ],
                    }),
                    (0, t.jsx)('p', {
                      className: 'text-sm uppercase',
                      children: o.weekdays[u.weekday],
                    }),
                  ],
                }),
              }),
