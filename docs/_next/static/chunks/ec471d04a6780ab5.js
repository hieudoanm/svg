(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    ((N.constructor = j), b(N, g.prototype), (N.isPureReactComponent = !0));
    var w = Array.isArray;
    function E() {}
  ...
  (e, t, r) => {
    ...
    let _ = u.default.forwardRef(function (e, t) {
        ...
        let M = u.default.useContext(p.RouterContext),
          F = !1 !== b,
          { href: R, as: L } = u.default.useMemo(() => {
            if (!M) {
              let e = g(o);
              return { href: e, as: s ? g(s) : e };
            }
            let [e, t] = (0, i.resolveHref)(M, o, !0);
            return { href: e, as: s ? (0, i.resolveHref)(M, s) : t || e };
          }, [M, o, s]),
          $ = u.default.useRef(R),
          H = u.default.useRef(L);
        C && (n = u.default.Children.only(r));
        let I = C ? n && 'object' == typeof n && n.ref : t,
          [A, D, U] = (0, m.useIntersection)({ rootMargin: '200px' }),
          B = u.default.useCallback(
            (e) => {
              ((H.current !== L || $.current !== R) &&
                (U(), (H.current = L), ($.current = R)),
                A(e));
            },
            [L, R, U, A]
          ),
          q = (0, x.useMergedRef)(B, I);
        u.default.useEffect(() => {
          !M || (D && F && v(M, R, L, { locale: E }));
        }, [L, R, D, E, F, M?.locale, M]);
        let z = {
          ref: q,
          onClick(e) {
        ...
        if ((0, f.isAbsoluteUrl)(L)) z.href = L;
          ...
          let e = void 0 !== E ? E : M?.locale;
          z.href =
            (M?.isLocaleDomain &&
              (0, h.getDomainLocale)(L, e, M?.locales, M?.domainLocales)) ||
            (0, y.addBasePath)((0, d.addLocale)(L, e, M?.defaultLocale));
        }
        return C
