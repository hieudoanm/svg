(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([
  ...
  (e, t, r) => {
    ...
    ((r.Activity = h),
      ...
      (r.isValidElement = O),
      (r.lazy = function (e) {
        return { $$typeof: g, _payload: { _status: -1, _result: e }, _init: R };
      }),
      (r.memo = function (e, t) {
  ...
  (e) => {
    ...
    (e.s(
      [
        ...
        0,
        () => {
          let [{ color: e }, o] = (0, n.useState)({ color: '#fb2c36' }),
            u = [
              { r: 228, g: 63, b: 0 },
              { r: 250, g: 228, b: 16 },
              { r: 85, g: 204, b: 59 },
                  ...
                  children: (0, t.jsx)('button', {
                    ...
                    onMouseMove: (e) => {
                      let t = e.target.getBoundingClientRect(),
                        n = (2 * (e.clientX - t.left)) / (t.right - t.left) - 1,
                        i = 1 - (2 * (e.clientY - t.top)) / (t.bottom - t.top),
                        a = ((Math.PI / 2 - Math.atan2(i, n)) / Math.PI) * 180;
                      a < 0 && (a += 360);
                      let l =
                          Math.floor((a = (a / 360) * (u.length - 1))) %
                          u.length,
                        s = (l + 1) % u.length,
                        c = u[l],
                        f = u[s],
                      ...
                      let b = h < 0.8 ? h / 0.8 : 1,
                        y = 1 - b;
                      ((g.r = Math.round(g.r * b + 255 * y)),
                        (g.g = Math.round(g.g * b + 255 * y)),
                        (g.b = Math.round(g.b * b + 255 * y)));
                      let m = ((e = 0, t = 0, n = 0) => {
                        (e > 255 && (e = 255),
                          t > 255 && (t = 255),
                          n > 255 && (n = 255),
