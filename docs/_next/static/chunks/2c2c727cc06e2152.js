        ...
        !(function e(t, r, n, o, l) {
          ...
          if (E(t))
            ...
            for (t = m.call(t), m = 0; !(o = t.next()).done; )
              ((f = p + C((o = o.value), m++)), (d += e(o, r, n, f, l)));
          else if ('object' === f) {
  ...
  (e, t, r) => {
    ...
    function c(e) {
      ...
      let w = e.serializers || {},
        j =
          ...
          Array.isArray(t)
            ...
            : !0 === t && Object.keys(w)),
        _ = e.browser.serialize;
      Array.isArray(e.browser.serialize) &&
        e.browser.serialize.indexOf('!stdSerializers.err') > -1 &&
        (_ = !1);
      let E = Object.keys(e.customLevels || {}),
        O = ['error', 'fatal', 'warn', 'info', 'debug', 'trace'].concat(E);
      ('function' == typeof x &&
      ...
      (N.log || (N.log = g),
        (l = {}),
        O.forEach((e) => {
          l[e] = x[e] ? x[e] : s[e] || s[a[e] || 'log'] || g;
        }),
        (N[o] = l),
        u({}, N),
        Object.defineProperty(N, 'levelVal', {
          get: function () {
      ...
      function T(t, r, n) {
        ...
        ((n = n || {}), j && r.serializers && (n.serializers = r.serializers));
        let s = n.serializers;
        if (j && s) {
          var i = Object.assign({}, w, s),
            o = !0 === e.browser.serialize ? Object.keys(i) : j;
          (delete r.serializers, d([r], o, i, this._stdErrSerialize));
        }
        function l(e) {
          ((this._childLevel = (0 | e._childLevel) + 1),
            (this.bindings = r),
            i && ((this.serializers = i), (this._serialize = o)),
            y && (this._logEvent = p([].concat(e._logEvent.bindings, r))));
        }
        l.prototype = this;
        let a = new l(this);
        return (
      ...
      return (
        (h = e.customLevels || {}),
        (N.levels = {
          values: Object.assign({}, c.levels.values, h),
          labels: Object.assign(
            {},
            c.levels.labels,
            ((m = {}),
            Object.keys((n = h)).forEach(function (e) {
              m[n[e]] = e;
            }),
            m)
          ),
        ...
        (N.serializers = w),
        (N._serialize = j),
        (N._stdErrSerialize = _),
        (N.child = function (...e) {
          return T.call(this, k, ...e);
        }),
        y && (N._logEvent = p()),
        N
      );
            ...
            children: (0, t.jsx)('div', {
              ...
              children: (0, t.jsxs)('div', {
                ...
                children: [
                  ...
                  ].map(({ title: e, description: r, dateTime: n }) =>
                    (0, t.jsx)(
                      'div',
                      {
    ...
    (e.s(
      [
        ...
        () => {
          ...
          let l = s.months[r.month],
            a = new Date(r.year, s.months.indexOf(l), 1).getDay(),
            u = (0, s.getNumberOfDaysPerMonth)(r.year)[s.months.indexOf(l)],
            c = ((e, t) => {
                  ...
                  children: [
                    ...
                    (0, t.jsxs)('p', {
                      children: [
                        r.date,
                        (0, t.jsx)('sup', {
                          children: (0, s.getOrdinalSuffix)(r.date),
                        }),
                      ],
                    }),
                  ],
      ...
      e.s(
        [
          ...
          () => {
            ...
            let o = s.months[r.month],
              l = s.weekdays[r.weekday];
            return (0, t.jsx)('div', {
              className:
